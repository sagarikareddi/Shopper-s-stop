  ...
  return (
    <Container>
      ...
      <Right>
        <Title>Contact</Title>
        <ContactItem>
          <Room style={{marginRight:"10px"}}/> 622 Monaco brouce , orchoterao 5311759
        </ContactItem>
        <ContactItem>
          <Phone style={{marginRight:"10px"}}/> +91 7702503054
        </ContactItem>
        <ContactItem>
          <MailOutline style={{marginRight:"10px"}} /> contact@Shooper's_stop.dev
        </ContactItem>
